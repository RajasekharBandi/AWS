...
public class CreateTablesLoadData {
    ...
    static String productCatalogTableName = "DTCC14Catalog";
    static String forumTableName = "DTCC14Forum";
    static String threadTableName = "DTCC14Thread";
    static String replyTableName = "DTCC14Reply";
